...
public class RegularExpressions {
	public static void main(String args[]){       
		...
		System.out.println(  
		     Pattern.matches("ravi", "Teja")); // This statement returns False because the string starts with the Upper-case letter which does not match with the regex.  
		...
		System.out.println(  
			     Pattern.matches("[praksh]", "kumar")); // This statement returns True because the string starts with 'T' which matches with a character T from Regex.  
